...
import { defaultFlexStyles, purpleMeshStyles, purpleInlineText } from "../utils/constants/styles";
        ...
        >
            ...
            >
                <Typography variant="h1" component="p">
                    {" "}
                    {
                        <Typography variant="h1" component="p" sx={{ ...purpleInlineText(theme) }}>
                            {" "}
                            Join Us{" "}
                        </Typography>
                    }{" "}
        ...
        >
            ...
            >
                ...
                <Box sx={{ width: "100%" }}>
                    ...
                    <Typography>
                        {" "}
                        New members are accepted twice a year during Fall and Spring recruitment
                        cycles. More details on the current process can be found [here].{" "}
                    </Typography>
                    <Stack
                        sx={{
                            flexDirection: {
        ...
        >
            ...
            >
                ...
                <Box>
                    ...
                    <Typography>
                        {" "}
                        PCS collaborates with other student orgs on projects, socials, and other
                        events. Reach out via{" "}
                        {
                            <Typography
                                sx={inlineLink}
                                component={Link}
            ...
            >
                ...
                <Box>
                    ...
                    <Typography>
                        ...
                        or want to explore a new research area, PCS members bring interdisciplinary
                        skillsets, creative solutions, and meaningful results to our partnerships
